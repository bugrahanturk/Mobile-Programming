...
public class AdapterLevel2 extends RecyclerView.Adapter<AdapterLevel2.CardViewTasarimNesneleriniTutucu>{
    private Context mContext;
    private List<Animals> my_animals;

    public AdapterLevel2(Context mContext, List<Animals> my_animals) {
    ...
    public CardViewTasarimNesneleriniTutucu onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_tasarim2,parent,false);
    ...
    public void onBindViewHolder(@NonNull CardViewTasarimNesneleriniTutucu holder, int position) {
        ...
        holder.resim_CardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (animal_name.equalsIgnoreCase(Level2Fragment.soru)){
