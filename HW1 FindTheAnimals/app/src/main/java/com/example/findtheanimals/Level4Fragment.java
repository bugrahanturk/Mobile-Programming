...
public class Level4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_level4,container,false); // tasarıma erişiyoruz rootView oluşturup
        ...
        while (GameActivity.R_numbers.size() < 5){
        ...
        adapter = new AdapterLevel4(getActivity(),animals);
