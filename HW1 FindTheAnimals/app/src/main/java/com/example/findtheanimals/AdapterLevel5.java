...
public class AdapterLevel5 extends RecyclerView.Adapter<AdapterLevel5.CardViewTasarimNesneleriniTutucu>{
    private Context mContext;
    private List<Animals> my_animals;

    public AdapterLevel5(Context mContext, List<Animals> my_animals) {
