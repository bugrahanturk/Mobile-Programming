...
public class AdapterLevel4 extends RecyclerView.Adapter<AdapterLevel4.CardViewTasarimNesneleriniTutucu>{
    private Context mContext;
    private List<Animals> my_animals;

    public AdapterLevel4(Context mContext, List<Animals> my_animals) {
    ...
    public void onBindViewHolder(@NonNull CardViewTasarimNesneleriniTutucu holder, int position) {
        ...
        holder.resim_CardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (animal_name.equalsIgnoreCase(Level4Fragment.soru)){
